	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
            ...
            include("dbconn.php");
            $email=$_GET["email"];
            $sql="select * from registration,verification where registration.email='$email' and verification.email='$email'";
                ...
                <div class="col-md-12 panel-grids">
                    ...
                    <table class="table">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                  ...
                                  <td><a href="../guide/<?php echo $r['adhaar']?>"><img src="../guide/<?php echo $r['adhaar']?>" width="250" height="280"></a></td>
                                  <td><a href="../guide/<?php echo $r['photo']?>"><img src="../guide/<?php echo $r['photo']?>" width="250" height="280"></a></td>
                              </tr>
                       ...
                       <!--  <a href="approve.php?email='<?php echo $r['email']?>'"><button type="button" class="btn btn-success"> Approve</button></a> -->
                        ...
                        <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Disable Account</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="rejectguide.php" method="POST">
