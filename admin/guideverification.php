	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
            <?php
            include("dbconn.php");
            $sql="select * from login,registration,verification where login.usertype='g' and login.status=0 and login.email=registration.email and login.email=verification.email";
