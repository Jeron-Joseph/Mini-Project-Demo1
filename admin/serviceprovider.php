                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="exampleModalLabel">Why you are disabling <?php echo $r["name"]?> account</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form action="disable.php" method="POST">
                                            <div class="form-group">
                                                <!-- <label for="recipient-name" class="control-label">Recipient:</label> -->
                                                <input type="hidden" name="email" class="form-control" id="recipient-name" value="<?php echo $r["email"]?>" readonly>
                                            </div>
                                            <div class="form-group">
