...
<body class="cbp-spmenu-push">
  ...
  <tbody>
            ...
            $sql="select * from room_booking a,registration b,payment c where a.sp_email='$email' and b.email=a.customer_email and a.room_booking_id=c.booking_id";
      ...
      <td><?php echo $r['vacating_date']?></td>
      <td><?php 
       $room_id=$r['room_id'];
       $s="select room_type from rooms where room_id=$room_id";
   ...
   ?></td>
    ...
    <h3 class="text-danger">Your Total Earning From Room Booking : <?php echo $sum ?> Rs</h3>
