...
<body class="cbp-spmenu-push">
    ...
    <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
        ...
        $em=$_SESSION['email'];
        $sql7="select * from notification where reciever_id='$em' order by notification_date desc";
  ...
  width: 50px;
  height: 50px;
  border-radius: 50%;" src="<?php echo $pic?>" alt=""> </span> 
                                    <div class="user-name">
                                        <?php echo $name ?>
                                        <span></span>
                         ...
                         <div class="panel-body"></div><?php echo $row['content']?></div> </div>
                         <?php
                     }
                 }
