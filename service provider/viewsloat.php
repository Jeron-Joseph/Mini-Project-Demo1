...
<body class="cbp-spmenu-push">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Sloat Time</th>
      <th scope="col">Sloat Date</th>
  ...
  <tbody>
            ...
            $sql="select * from sloat_booking a,registration b where a.sp_email='$email' and b.email=a.customer_email";
      ...
      <td><?php echo $r['sloat_time']?></td>
      <td><?php echo $r['sloat_date']?></td>
