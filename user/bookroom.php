...
$sql="insert into room_booking(customer_email,sp_email,arrival_date,vacating_date,room_id,no_of_rooms)values('$email','$sp_email','$date1','$date2',$room_id,$rooms)";
if(mysqli_query($conn,$sql)){
	...
	if(mysqli_query($conn,$sql)){
		...
		echo "<script>
	window.location.replace('payment/roomspayment.php?room_id=$room_booking_id&urooms=$room_id')
