    ...
    <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
        ...
        <div id="page-wrapper">
            ...
            ?>
            <div class="card">
            <h3><img src="<?php echo $r['profile_pic']?>" style="
  width: 90px;
  height: 90px;
  border-radius: 50%;"><?php echo $r['name']?></h3>
  <form action="updateprofile.php" method="POST" enctype="multipart/form-data">
    <div class="col-md-4">
        
      <label>Update Profile</label>
      <input type="file" name="profile_pic" class="form-control" value="<?php echo $r['profile_pic']?>" required>
      </div>
      <div class="clearfix"></div>
      <br>
      <div class="col-md-4"><button type="submit" name="pic" class="btn btn-success">Update Profile Picture</button></div>
  </form>
      <div class="clearfix"></div>
    ...
    <div class="col-md-4">
      ...
      <div class="col-md-4">
      <button type="submit" class="btn btn-success" name="data">Update</button>
  </div>
  </form>
</div>
