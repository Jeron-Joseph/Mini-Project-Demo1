...
$sql="select profile_pic from registration where email='$email'";
...
<h2 class="text-success text-center">Explore Chat</h2>
...
<div class="container bg-success text-light">
  ...
  width: 50px;
  height: 50px;
  border-radius: 50%;" src="<?php echo $customer_pic ?>" alt=""><?php echo $customer_name?>
