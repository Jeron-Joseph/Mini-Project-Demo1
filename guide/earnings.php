...
<body class="cbp-spmenu-push">
  ...
  <thead>
   ...
   <tbody>
            ...
            $sum=0;
            $sql="select * from payment a,registration b,booking c where a.sp_email='$email' and a.booking_id=c.booking_id and a.customer_email=b.email";
      ...
      <td class="text-success">Payments success</td>
        ...
        <h3 class="text-danger">Your Total Earnings <?php echo $sum?></h3>
        <?php
    }
    ?>
