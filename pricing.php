...
<html lang="en">
<head>
<title>In Travel Travel Category Flat Bootstrap Responsive Website Template | Pricing : W3layouts</title>
...
<!--/pricing -->
	<section class="team py-5" id="pricing">
		...
		<h2 class="heading text-center mb-sm-5 mb-4">Our Pricing</h2>
